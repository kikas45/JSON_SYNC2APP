...
public class AddNewSchedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (preferences.getBoolean("darktheme", false)) {
            ...
            activity.parentConatiner.setBackgroundColor(getResources().getColor(R.color.dark_layout_for_ui));
            //  activity.addScheduleBtn.setBackgroundColor(getResources().getColor(R.color.dark_layout_for_ui));
            activity.subParentlayout.setBackgroundColor(getResources().getColor(R.color.dark_layout_for_ui));
            setDrawableColor(activity.navBackArrow, R.drawable.ic_swipe_left, R.color.white);
            setDrawableColor(activity.navMoveFront, R.drawable.ic_swipe_right, R.color.white);
            setDrawableColor(activity.backButton, R.drawable.ic_arrow_back_24, R.color.white);
            setDrawableColor(activity.imagSpannerSavedDownload, R.drawable.ic_drop_down_24, R.color.white);


            setTextColor(activity.textTitle, R.color.white);
            setTextColor(activity.textOnline, R.color.white);
            setTextColor(activity.locationIndicator, R.color.white);
            setTextColor(activity.textTimePreference, R.color.white);
            setTextColor(activity.textUseCurrentTime, R.color.white);
            setTextColor(activity.textRedirecturl, R.color.white);
            setTextColor(activity.textScheduleTraining, R.color.white);
            setTextColor(activity.textSetTime, R.color.white);
            setTextColor(activity.startTime, R.color.white);
            setTextColor(activity.textEndTime, R.color.white);
            setTextColor(activity.stopTime, R.color.white);
            setTextColor(activity.textScheduleNormal, R.color.white);
            setTextColor(activity.typeIndicator, R.color.white);
            setTextColor(activity.textStartDate, R.color.white);
            setTextColor(activity.startDate, R.color.white);
            setTextColor(activity.textEnddate, R.color.white);
            setTextColor(activity.endDate, R.color.white);
            setTextColor(activity.textScheduleScope, R.color.white);
            setTextColor(activity.scopeIndicator, R.color.white);
            setTextColor(activity.addText, R.color.white);

            // stback ground color for the text view
            activity.startTime.setBackgroundResource(R.drawable.edittext_ring_dark);
            activity.stopTime.setBackgroundResource(R.drawable.edittext_ring_dark);
            activity.startDate.setBackgroundResource(R.drawable.edittext_ring_dark);
            activity.endDate.setBackgroundResource(R.drawable.edittext_ring_dark);

            // Set background resource
            activity.currentTime.setBackgroundResource(R.drawable.round_edit_text_design_outline_dark_theme);
            activity.currentTime.setTextColor(getResources().getColor(R.color.white));
            activity.currentTime.setHintTextColor(getResources().getColor(R.color.light_gray_wash));

            activity.redirectUrl.setBackgroundResource(R.drawable.round_edit_text_design_outline_dark_theme);
            activity.redirectUrl.setTextColor(getResources().getColor(R.color.white));
            activity.redirectUrl.setHintTextColor(getResources().getColor(R.color.light_gray_wash));

            activity.innerCurveCardLayout.setBackgroundResource(R.drawable.card_outline_button_dark);


            // Set radio button icon color to white
            activity.deviceRadio.setTextColor(Color.WHITE);
            activity.serverRadio.setTextColor(Color.WHITE);

            ColorStateList colorStateList = ColorStateList.valueOf(Color.WHITE);
            CompoundButtonCompat.setButtonTintList(activity.deviceRadio, colorStateList);
            CompoundButtonCompat.setButtonTintList(activity.serverRadio, colorStateList);
            ...
            activity.locationSwitch.setThumbTintList(thumbColorStateList);
            activity.locationSwitch.setTrackTintList(trackColorStateList);

            activity.typeSwitch.setThumbTintList(thumbColorStateList);
            activity.typeSwitch.setTrackTintList(trackColorStateList);

            activity.scopeSwitch.setThumbTintList(thumbColorStateList);
            activity.scopeSwitch.setTrackTintList(trackColorStateList);
