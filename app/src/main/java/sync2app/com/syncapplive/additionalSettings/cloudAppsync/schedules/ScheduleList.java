...
public class ScheduleList extends AppCompatActivity {
    ...
    //binding
    private ActivityScheduleListBinding activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set binding
        activity = DataBindingUtil.setContentView(this, R.layout.activity_schedule_list);
    ...
    private void initialize() {
        ...
        //clear schedules
        activity.clearSchedules.setOnClickListener(v -> {
    ...
    private void loadSchedules() {
        ...
        layoutManager.setReverseLayout(true);
        layoutManager.setStackFromEnd(true);
        activity.scheduleRecycler.setLayoutManager(layoutManager);

        adapter = new ScheduleAdapter(scheduleList, this, this);
        activity.scheduleRecycler.setAdapter(adapter);
